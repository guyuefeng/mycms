...
namespace Mycms.Web.UI
{
    ...
    {
        protected internal Mycms.Model.siteconfig siteConfig;
        ...
        public bool IsAdminLogin()
        {
            ...
            {
                //检查Cookies
                string adminname = Utils.GetCookie("AdminName", "Mycms"); //解密用户名
                string adminpwd = Utils.GetCookie("AdminPwd", "Mycms");
