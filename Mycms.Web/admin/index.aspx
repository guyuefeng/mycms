<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="Mycms.Web.admin.index" %>
  ...
  <div position="top" class="header">
            <div class="header_box">
                <div class="header_right">
                    <span><b><%=admin_info.user_name %>（<%=new Mycms.BLL.manager_role().GetTitle(admin_info.role_id) %>）</b>您好，欢迎光临</span>
        ...
        <div position="bottom" class="footer">
            <div class="copyright">Copyright &copy; 2009 - 2012. Mycms.net. All Rights Reserved.</div>
        </div>
    </div>
</form>
</body>
