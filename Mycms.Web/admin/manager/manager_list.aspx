<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_list.aspx.cs" Inherits="Mycms.Web.admin.manager.manager_list" %>
...
<form id="form1" runat="server">
    ...
    <ItemTemplate>
      <tr>
        ...
        <td><%#new Mycms.BLL.manager_role().GetTitle(Convert.ToInt32(Eval("role_id")))%></td>
