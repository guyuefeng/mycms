...
namespace Mycms.BLL
{
    ...
    {
        private readonly Mycms.DAL.manager_role dal = new Mycms.DAL.manager_role();
        public manager_role()
        { }
        #region  Method
        /// <summary>
        ...
        /// 增加一条数据
        /// </summary>
        public int Add(Mycms.Model.manager_role model)
        {
        ...
        /// 更新一条数据
        /// </summary>
        public bool Update(Mycms.Model.manager_role model)
        {
