...
namespace Mycms.DAL
{
    ...
    public partial class manager_role
    {
        ...
        /// 得到一个对象实体
        /// </summary>
        public Mycms.Model.manager_role GetModel(int id)
        {
            StringBuilder strSql = new StringBuilder();
            ...
            Mycms.Model.manager_role model = new Mycms.Model.manager_role();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds2.Tables[0].Rows.Count > 0)
                {
                    ...
                    List<Mycms.Model.manager_role_value> models = new List<Mycms.Model.manager_role_value>();
                    Mycms.Model.manager_role_value modelt;
                    for (int n = 0; n < i; n++)
                    {
                        modelt = new Mycms.Model.manager_role_value();
